...
user = UserProxyAgent(
    ...
    function_map={"filter_data": dataset.filter_data}
)
...
if __name__ == "__main__":
    ...
    groupchat = GroupChat(agents=[user,profile_interpreter,program_data,program_fit_evaluator,study_recommendation]
                       ,messages=[] )
